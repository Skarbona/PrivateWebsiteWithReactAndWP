...
<head>
    ...
    <link rel="shortcut icon" href="/wp-content/themes/filip/favicon.ico?" type="image/x-icon">
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/filip in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/filip) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/filip/favicon.ico" will
